      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage clients and markets for the report automation system.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add and manage client companies</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add and manage market regions</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {/* Add Market Form */}
                ...
                <div className="flex gap-2">
                  <div className="w-1/3">
                    <Input
                      ...
                      value={newMarketCode}
                      onChange={(e) =>
                        setNewMarketCode(e.target.value.toUpperCase())
                      }
                      maxLength={5}
