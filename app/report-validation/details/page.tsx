...
export default function ReportValidationDetails() {
  ...
  const tableData: DataRow[] = [
    { id: 13, orderID: 'ORD-1248', date: '2023-05-18', amount: '450.00', status: 'Shipped' },
    { id: 14, orderID: 'ORD-1249', date: '2023-05-18', amount: '25.00', status: 'Pending', hasError: true },
    { id: 15, orderID: 'ORD-1250', date: '', amount: '1200.00', status: 'Shipped', hasError: true },
    { id: 16, orderID: 'ORD-1251', date: '2023-05-19', amount: '75.50', status: 'Delivered' },
    { id: 17, orderID: 'ORD-1252', date: '2023-05-20', amount: '300.00', status: 'Shipped' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        <h1 className="text-xl font-semibold text-gray-900">Report Validation Details</h1>
                ...
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {tableData.map((row) => (
                      <tr
                        key={row.id}
                        className={row.hasError ? 'bg-red-50' : 'hover:bg-gray-50'}
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                          <span className={row.hasError && row.amount ? 'border-2 border-red-400 px-2 py-1 rounded' : ''}>
                            {row.amount}
                          </span>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
