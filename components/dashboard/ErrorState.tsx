...
> = {
  ...
  timeout: {
    ...
    description:
      "The request took too long to complete. This might be due to a large dataset. Try selecting fewer fields.",
  ...
  notFound: {
    ...
    description:
      "No data found for the selected query. Try adjusting your filters or selecting different fields.",
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="max-w-md text-center">
        <div
          className={`w-16 h-16 rounded-2xl bg-slate-100 flex items-center justify-center mx-auto mb-6`}
        >
